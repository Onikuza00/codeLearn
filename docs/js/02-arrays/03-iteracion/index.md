...
!!! warning "Ya viste while/for/do-while en detalle"
    La mecánica de cada bucle (condición, actualización, scope) está cubierta en [Control de flujo](../../01-basico/03-estructuras-control/index.md). Aquí el foco es específicamente **cuál conviene para recorrer un array**, no cómo funciona cada uno por dentro.
